        ...
        if ( 0 == 1 ) // modifier le test
        {
          ?>
            <form class="navbar-form navbar-right" role="search">
              <input type="text" placeholder="Inscription_1" name="Inscription_2" /><br /><!-- ajouter un lien pour s inscrire  -->
              <input type="text" placeholder="Connection_1" name="Connection_2" /><br /><!-- ajouter un lien pour se connecter -->
            </form>
          <?php
        }
        else
          ...
          if ( 1 == 1 )
          {
            ?>
              <form class="navbar-form navbar-right" action="prog.php" method=POST>
                <input type="text" placeholder="identifient_1" name="identifient_2" /><br />
